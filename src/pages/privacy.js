    ...
    <Layout>
      <section className={styles.privacySection}>
        ...
        <div className="textContainer">
          ...
          <p>
            We automatically collect non-personal information, i.e., information
            that is not associated with a specific individual, from you when you
            visit the Websites and/or use our Services. This information may
            include your Internet Protocol ("IP") address (which is the number
            automatically assigned to your computer whenever you access the
            Internet), browser type and language, Internet service provider
            (“ISP”), referring and exit pages, operating system, date and time
            stamp, and other data. The IP address does not identify your name,
            email address, or other personal information. We may use your IP
            address to help diagnose problems with our server, to administer our
            Websites, understand and analyze trends, learn about user behavior
            on the site, and to gather demographic information about our user
            base as a whole.
          </p>
        </div>
        ...
        <div className="textContainer">
          ...
          <h4>Contact Form</h4>
          <p>
            If you contact us using the contact form, we will collect your name
            and e-mail address (and any additional data you may provide us with)
            to be able to respond to your questions.
          </p>

          <h4>Newsletter Sign Up</h4>
          <p>
            Currently newsletter-signup is disabled. No data will be sent or
            stored when you submit your email address.
          </p>
        </div>
        ...
        <div className="textContainer">
          ...
          <p>
            Any data submitted during the checkout process (order placement)
            will be deleted on a regular basis, at least every 3 months.
          </p>
          <p>
            Data submitted through the contact form will emailed directly to us
            and not stored in the database. Emails generated through this
